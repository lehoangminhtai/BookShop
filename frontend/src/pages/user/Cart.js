...
const Cart = () => {
    ...
    useEffect(() => {
        // Hàm bất đồng bộ để lấy chi tiết cho mỗi sản phẩm trong giỏ hàng
                                ...
                                return (
                                    <div key={item.id} className="row align-items-center pb-3" >
                                        <div className="col-3 col-md-2 d-flex align-items-center">
                                            ...
                                            <img
                                                src={product ? product.images : 'https://placehold.co/100x150'} // Thay thế bằng ảnh sản phẩm thực
                                        ...
                                        <div className="col-9 col-md-6">
                                            ...
                                            <p className="text-danger fw-semibold mb-0" style={{ fontSize: '14px' }}>
                                                {/* {product ? product.price.toLocaleString() : 'Loading...'} đ */}
                                            </p>
                                        </div>
                                        <div className="col-12 col-md-4 d-flex align-items-center" style={{ marginTop: '10px' }}>
                                            <div className="d-flex align-items-center me-4">
                                                <button className="btn btn-outline-secondary btn-sm px-2">-</button>
                                            ...
                                            <span className="text-danger fw-semibold ms-4 text-center" style={{ width: '120px', fontSize: '16px' }}>
                                                {/* {(product ? product.price * item.quantity : 0).toLocaleString()} đ */}
                                            </span>
                                            <button className="btn btn-link text-muted ms-3"><i className="fas fa-trash-alt"></i></button>
                                        </div>
                                    </div>
                                );
                            })}
